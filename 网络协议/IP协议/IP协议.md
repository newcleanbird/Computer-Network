...
- 假设该子网当中有一台主机对应的IP地址是 `192.168.128.10`，那么将这个IP地址与该网络对应的子网掩码进行“按位与”操作后得到的就是192.168.128.0，这就是这个子网对应的网络号。
...
- IPv6：使用128位地址空间，提供了几乎无限的地址数量，解决了IPv4地址耗尽的问题，同时引入了更高效的路由和更好的安全性。
